...
(function () {
    'use strict';
    return angular
            .module('restangular-object-cache', ['restangular'])
            .service('RestangularObjectCache', restangularObjectCache);

    function restangularObjectCache(Restangular) {
        var HasManyDefinition, HasOneDefinition, ObjectCache,
                RelationshipsDefiner, addIndex, createTracking,
                guessKeyFromModelName, guessModelNameFromSingular,
                objectCaches, relationshipDefinitions,
                validateModelName, valuesAt, wireModel, wireRelationships;
